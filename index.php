        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                <form action="" method="post">
                    ...
                    <input type="text"
                        class="form-control" name="tarea" id="tarea" aria-describedby="helpId" placeholder="Descripción de tarea">
                    <br/>
            ...
            <?php foreach($registros as $registro){ ?>
                ...
                <input class="form-check-input float-start" type="checkbox" name="completado" value="<?php echo $registro['completado'];?>" id="" 
